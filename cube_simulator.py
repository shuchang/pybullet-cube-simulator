...
def main():
    ...
    cubeT = Cube([0.00, 0.00, 0.97], p.getQuaternionFromEuler([0, 0, -np.pi/2]), pb_client)
    cubeL = Cube([-0.28, 0.05, 0.97], p.getQuaternionFromEuler([0, 0, np.pi/2]), pb_client)
    cubeV = Cube([0.04, -0.11, 1.21], p.getQuaternionFromEuler([0, np.pi/2, np.pi]), pb_client)
    cubeZ = Cube([-0.14, -0.10, 1.15], p.getQuaternionFromEuler([0, np.pi/2, 0]), pb_client)
    ...
    cubeT.load("cubes/cube1.urdf", [-1.6, 1., 0.97], p.getQuaternionFromEuler([0, 0, 0]))
    cubeL.load("cubes/cube2.urdf", [-0.9, 1., 0.97], p.getQuaternionFromEuler([0, 0, 0]))
    cubeV.load("cubes/cube3.urdf", [-0.4, 1., 0.97], p.getQuaternionFromEuler([0, 0, 0]))
    cubeZ.load("cubes/cube4.urdf", [0.2, 1., 0.97], p.getQuaternionFromEuler([0, 0, 0]))
